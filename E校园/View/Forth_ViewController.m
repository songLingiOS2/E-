...
@interface Forth_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UITableView *tableView1;
}
@end

@implementation Forth_ViewController
